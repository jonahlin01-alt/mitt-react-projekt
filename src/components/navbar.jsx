    ...
    <nav className={`navbar navbar-expand-lg ${navbarBgClass} border-bottom`}>
      <div className="container-fluid position-relative">
        ...
        <div className="collapse navbar-collapse" id="mainNavbar">
          <ul className="navbar-nav ms-auto mb-2 mb-lg-0 d-flex flex-row align-items-center position-relative">
            {navItems.map((item, index) => (
              ...
              >
                ...
                {item.value === "development" && showDropdown && (
                  <div
                    className={`position-absolute top-100 end-0 mt-3 rounded shadow p-3 ${
